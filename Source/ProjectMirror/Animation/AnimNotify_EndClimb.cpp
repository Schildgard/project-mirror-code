...
#include "AnimNotify_EndClimb.h"

#include "ProjectMirror/Characters/Components/ClimbComponent.h"

void UAnimNotify_EndClimb::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation, const FAnimNotifyEventReference& EventReference)
{
	if (!IsValid(MeshComp))
	{
		return;
	...
	ClimbComponent->CompleteClimbing();
}
